...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { insurance_facility_id: @insurance.insurance_facility_id, name: @insurance.name, notes: @insurance.notes }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { insurance_facility_id: @insurance.insurance_facility_id, name: @insurance.name, notes: @insurance.notes }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
